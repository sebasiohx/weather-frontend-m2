...
const regiones = [
  ...
  /* ── 15 ── Metropolitana (al final según lo solicitado) */
  {
    ...
    descripcion:
      "Santiago es la capital de Chile y una de las metrópolis más modernas e importantes de Latinoamérica, con más de siete millones de habitantes. Rodeada por la majestuosa Cordillera de los Andes al oriente y la Cordillera de la Costa al poniente, ofrece una postal única de montañas nevadas en días despejados. La ciudad concentra los principales centros culturales, financieros y gubernamentales del país, conviviendo barrios históricos con rascacielos ultramodernos. A solo una hora se puede combinar la playa de Viña del Mar con el snow de las estaciones de ski de la cordillera.",
    tempMinima: 9,
    tempMaxima: 33,
    tempActual: 28,
    estadoClimatico: climas.soleado,
